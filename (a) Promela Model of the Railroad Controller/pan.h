...
#define PanSource	"railroad_controller.pml"
...
#define _nstates2	6	/* Monitor */
#define minseq2	41
#define maxseq2	45
#define _endstate2	5

#define _nstates1	17	/* Train */
#define minseq1	25
#define maxseq1	40
#define _endstate1	16

#define _nstates0	26	/* Controller */
#define minseq0	0
#define maxseq0	24
...
#define PTrain	((P1 *)_this)
typedef struct P1 { /* Train */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, recvd) - 1*sizeof(uchar))
...
typedef struct State {
	...
	uchar signalW;
	uchar signalE;
	uchar ControllerStateW;
	uchar ControllerStateE;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar TrainStateW;
/* hidden variable: */	uchar TrainStateE;
